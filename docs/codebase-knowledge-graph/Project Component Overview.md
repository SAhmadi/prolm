...
Back to [[Codebase Knowledge Graph]].
...
Related note: [[Project Files And Metadata]].
...
Related note: [[Dependency Install Flow]].
...
Related note: [[Runtime Test And Check Flow]].
...
Related note: [[Scaffolding And UX]].
...
Related notes: [[CLI Surface]] and [[Scaffolding And UX]].
