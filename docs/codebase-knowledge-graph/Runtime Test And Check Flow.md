...
- [[Project Files And Metadata]] supplies runtime config and entry metadata.
- [[Dependency Install Flow]] populates installed dependency paths before these
  commands need them.
- [[CLI Surface]] owns command wiring and output contracts.
